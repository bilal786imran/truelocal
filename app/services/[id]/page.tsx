  ...
  const fetchServiceDetails = async () => {
    try {
      ...
      if (data?.images?.length > 0) {
        setMainImage(data.images[0]); // default to first image
      }
    } catch (error) {
      console.error("Error fetching service:", error);
    } finally {
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="font-bold text-lg">
                      {service.profiles?.years_experience || 0}
                    </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Service radius: {service.service_radius} miles
                  </p>
                </div>
              </CardContent>
            </Card>
                  ...
                  <TabsContent value="about" className="mt-6">
                    <div className="flex items-start gap-4">
                      <Avatar className="w-16 h-16">
                        <AvatarImage
                          src={
                            service.profiles?.avatar_url || "/placeholder.svg"
                          }
                        />
                        <AvatarFallback>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {service.profiles?.years_experience || 0} years
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Service Radius:</span>
                    <span className="font-medium">
                      {service.service_radius} miles
                    </span>
                  </div>
                </div>
              </CardContent>
